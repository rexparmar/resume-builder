...
import { ArrowLeftIcon, Briefcase, ChevronLeft, ChevronRight, Download, EyeIcon, EyeOff, FileText, FolderIcon, GraduationCap, Share2Icon, ShareIcon, SparkleIcon, Sparkles, User } from 'lucide-react';
import PersonalInfoForm from '../componenets/PersonalInfoForm';
import ResumePreview from '../componenets/ResumePreview';
import TemplateSelector from '../componenets/TemplateSelector';
import ColorPicker from '../componenets/ColorPicker';
import ProfessionalSummaryForm from '../componenets/ProfessionalSummaryForm';
import ExperienceForm from '../componenets/ExperienceForm';
import EducationForm from '../componenets/EducationForm';
import ProjectForm from '../componenets/ProjectForm';
import SkillsForm from '../componenets/SkillsForm';
...
const ResumeBuilder = () => {
  ...
  const handleShare = () => {
    ...
    if(navigator.share){
      ...
      alert("Sharing not supported on this browser. Try in different one.")
    }
  }
            ...
            <div className='bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1'>
              ...
              <div className='flex justify-between items-center mb-6 border-b border-gray-300 py-1'>
                <div className='flex items-center gap-2'>
                  ...
                  <ColorPicker selectedColor={resumeData.color} onChange={(color)=>setResumeData(prev=>({...prev, accent_color:color}))}/>
                </div>
